...
person* create_family(int generations)
{
    ...
    person* individual = (person*) malloc(sizeof(person));
    if (individual == NULL)
    {
    ...
    if (generations > 1)
    {
        ...
        individual->alleles[0] = random_allele_from_parents(parent0);
        individual->alleles[1] = random_allele_from_parents(parent1);
    }
